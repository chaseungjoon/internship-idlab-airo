"""M1 submodule 0 (physical): detect a single brick on the table and hover above it.

Robot/camera connection, hand-eye calibration loading and the reachable top-down orientation search
all live in ``config.py`` (the one place this cell's hardware is described); everything below is the
detection itself.
"""
